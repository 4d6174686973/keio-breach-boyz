...
set JARPATH=%APP_HOME%\lib\sample-1.0-SNAPSHOT.jar

@rem Execute multi-storage-transaction-sample
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MULTI_STORAGE_TRANSACTION_SAMPLE_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%MULTI_STORAGE_TRANSACTION_SAMPLE_EXIT_CONSOLE%" exit 1
exit /b 1
